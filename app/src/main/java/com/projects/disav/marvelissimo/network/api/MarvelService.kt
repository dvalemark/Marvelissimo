...
interface MarvelService {
    ...
    @GET("characters/{id}")
    fun getOneCharacter(@Path("id") searchVal :String): Single<CharacterDataWrapper>

    @GET("comics")
    fun getAllComic(): Single<ComicsDataWrapper>

    @GET("comics")
    fun getComicsByNameStartingWith(@Query("nameStartsWith")nameStart: String): Single<CharacterDataWrapper>
